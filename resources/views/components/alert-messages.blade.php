@if (session('success'))
    <div class="mb-4 rounded-lg bg-green-100 border border-green-400 text-green-800 px-4 py-3 flex items-center gap-2" role="alert">
...
@if (session('error'))
    <div class="mb-4 rounded-lg bg-red-100 border border-red-400 text-red-800 px-4 py-3 flex items-center gap-2" role="alert">
...
@if (session('warning'))
    <div class="mb-4 rounded-lg bg-yellow-100 border border-yellow-400 text-yellow-800 px-4 py-3 flex items-center gap-2" role="alert">
...
@if (session('info'))
    <div class="mb-4 rounded-lg bg-blue-100 border border-blue-400 text-blue-800 px-4 py-3 flex items-center gap-2" role="alert">
...
@if ($errors->any())
    <div class="mb-4 rounded-lg bg-red-100 border border-red-400 text-red-800 px-4 py-3" role="alert">
