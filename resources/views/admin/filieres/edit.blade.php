    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-slate-900 overflow-hidden shadow-xl sm:rounded-3xl border border-gray-100 dark:border-slate-800 p-8 lg:p-12">
                ...
                <form action="{{ route('admin.filieres.update', $filiere) }}" method="POST" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="code" id="code" value="{{ old('code', $filiere->code) }}" required class="block w-full rounded-2xl border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white shadow-sm focus:border-upf-magenta focus:ring-upf-magenta font-mono uppercase">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $filiere->name) }}" required class="block w-full rounded-2xl border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white shadow-sm focus:border-upf-magenta focus:ring-upf-magenta font-bold">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" class="block w-full rounded-2xl border-gray-300 dark:border-slate-700 dark:bg-slate-800 dark:text-white shadow-sm focus:border-upf-magenta focus:ring-upf-magenta">{{ old('description', $filiere->description) }}</textarea>
                    ...
                    <div class="flex justify-end pt-6">
                        ...
                        <button type="submit" class="inline-flex items-center px-8 py-3 bg-upf-blue border border-transparent rounded-xl font-black text-white uppercase tracking-widest hover:bg-upf-navy focus:outline-none focus:ring-2 focus:ring-upf-blue focus:ring-offset-2 transition shadow-lg">
